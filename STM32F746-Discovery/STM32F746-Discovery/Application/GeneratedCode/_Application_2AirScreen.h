...
#ifndef _Application_2AirScreen_H
#define _Application_2AirScreen_H
...
/* Forward declaration of the class Application_2::AirScreen */
#ifndef _Application_2AirScreen_
  EW_DECLARE_CLASS( Application_2AirScreen )
#define _Application_2AirScreen_
#endif
...
/* Deklaration of class : 'Application_2::AirScreen' */
EW_DEFINE_FIELDS( Application_2AirScreen, CoreGroup )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( Rectangle1,      ViewsRectangle )
  EW_OBJECT  ( Text,            ViewsText )
  EW_OBJECT  ( down_apper,      ViewsImage )
  EW_OBJECT  ( down_hiden,      ViewsImage )
  EW_OBJECT  ( TouchDown,       CoreSimpleTouchHandler )
  EW_OBJECT  ( up_apper,        ViewsImage )
  EW_OBJECT  ( up_hiden,        ViewsImage )
  EW_OBJECT  ( TouchUp,         CoreSimpleTouchHandler )
  EW_OBJECT  ( tempuText,       ViewsText )
  EW_OBJECT  ( Text2,           ViewsText )
  EW_OBJECT  ( power_apper,     ViewsImage )
  EW_OBJECT  ( power_hiden,     ViewsImage )
  ...
  EW_OBJECT  ( exit,            ViewsImage )
  EW_OBJECT  ( speed_apper,     ViewsImage )
  EW_OBJECT  ( speed_hiden,     ViewsImage )
  EW_OBJECT  ( TouchSpeed,      CoreSimpleTouchHandler )
EW_END_OF_FIELDS( Application_2AirScreen )

/* Virtual Method Table (VMT) for the class : 'Application_2::AirScreen' */
EW_DEFINE_METHODS( Application_2AirScreen, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( Application_2AirScreen _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( Application_2AirScreen _this, XSet aState )
  EW_METHOD( InvalidateArea,    void )( CoreGroup _this, XRect aArea )
EW_END_OF_METHODS( Application_2AirScreen )
...
#endif /* _Application_2AirScreen_H */
