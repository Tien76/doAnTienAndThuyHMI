...
const XClass EwApplicationClass = EW_CLASS( Application_2Application );
...
/* 'C' function for method : 'Core::SimpleTouchHandler.OnSetLimitToFinger()' */
void CoreSimpleTouchHandler_OnSetLimitToFinger( CoreSimpleTouchHandler _this, XInt32 
  value )
{
  if ( value < 0 )
    value = -1;
