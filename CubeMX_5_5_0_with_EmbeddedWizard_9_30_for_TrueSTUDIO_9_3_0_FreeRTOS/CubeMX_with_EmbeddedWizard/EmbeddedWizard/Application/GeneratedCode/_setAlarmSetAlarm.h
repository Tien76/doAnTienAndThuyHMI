...
#ifndef _setAlarmSetAlarm_H
#define _setAlarmSetAlarm_H
...
/* Forward declaration of the class setAlarm::SetAlarm */
#ifndef _setAlarmSetAlarm_
  EW_DECLARE_CLASS( setAlarmSetAlarm )
#define _setAlarmSetAlarm_
#endif


/* Deklaration of class : 'setAlarm::SetAlarm' */
EW_DEFINE_FIELDS( setAlarmSetAlarm, CoreGroup )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( Border,          ViewsBorder )
  EW_OBJECT  ( upHour,          ViewsImage )
  EW_OBJECT  ( upMin,           ViewsImage )
  EW_OBJECT  ( upPmAm,          ViewsImage )
  EW_OBJECT  ( downHour,        ViewsImage )
  EW_OBJECT  ( dowmMin,         ViewsImage )
  EW_OBJECT  ( downAmPm,        ViewsImage )
  EW_OBJECT  ( hourText,        ViewsText )
  EW_OBJECT  ( Text1,           ViewsText )
  EW_OBJECT  ( minText,         ViewsText )
  EW_OBJECT  ( amPmText,        ViewsText )
  EW_OBJECT  ( colorChoise,     ViewsRectangle )
  EW_OBJECT  ( Image2,          ViewsImage )
  EW_OBJECT  ( pushUpHour,      WidgetSetPushButton )
  EW_OBJECT  ( pushUpMin,       WidgetSetPushButton )
  EW_OBJECT  ( pushUpAmPm,      WidgetSetPushButton )
...
EW_DEFINE_METHODS( setAlarmSetAlarm, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( setAlarmSetAlarm _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( setAlarmSetAlarm _this, XSet aState )
  EW_METHOD( InvalidateArea,    void )( CoreGroup _this, XRect aArea )
EW_END_OF_METHODS( setAlarmSetAlarm )
