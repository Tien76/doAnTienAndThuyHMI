...
*
* DESCRIPTION:
*   Initialize the DMA2D graphics hdma2d.
*
* ARGUMENTS:
...
*
* DESCRIPTION:
*   Deinitialize the DMA2D graphics hdma2d.
*
* ARGUMENTS:
*   None
*
  ...
  uint32_t aSrcColorMode, uint32_t aSrcColor )
{
  ...
  /* prepare destination output configuration */
  hdma2d.Init.Mode                  = ((aDstColorMode == aSrcColorMode) && (alpha == 0xFF)) ? DMA2D_M2M : DMA2D_M2M_PFC;
  hdma2d.Init.ColorMode             = aDstColorMode;
  hdma2d.Init.OutputOffset          = aDstOffset;
